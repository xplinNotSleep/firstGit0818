...
namespace AG.COM.SDM.GeoDataBase.DBuilder
{
    ...
    public class ItemPropertyDescriptor:PropertyDescriptor
    {
        ...
        public ItemPropertyDescriptor(object pComponent, PropertyDescriptor pPropertyDescriptor):base(pPropertyDescriptor)
        {
        ...
        public override void SetValue(object component, object value)
        {
            ...
            ItemProperty itemProperty = component as ItemProperty;
            //实例化事件参数
            ItemPropertyEventArgs itemPropertyArgs = new ItemPropertyEventArgs(itemProperty, value);
            //通知所有通知此事件的对象
            itemProperty.OnItemPropertyValueChanged(itemProperty, itemPropertyArgs);
        }
